...
export class WrapviewVectorObject {
...
export class WrapviewVectorPath extends WrapviewVectorObject {
    constructor(settings) {
        super(settings);
        this.type = 'path';
        this.init();
...
export class WrapviewVectorCircle extends WrapviewVectorObject {
...
export class WrapviewVectorImage extends WrapviewVectorObject {
